        ...
        <div className="columns is-multiline margin-top">
          ...
          <div className="column is-four-fifths">
            <Switch>
              ...
              <Route
                exact
                path="/forum/:id/posts/:id/editPost"
                component={withAuth(EditPost)}
              />
              <Route
                exact
                path="/posts/:id/comments/:id/EditComment"
                component={withAuth(EditComment)}
              />
              <Route
                exact
                path="/forum/:id/posts/:id/comments"
                component={CommentList}
              />
              <Route
                exact
                path="/forum/:id/createPost"
                component={withAuth(CreatePost)}
              />
              <Route
                exact
                path="/posts/:id/createComment"
                component={withAuth(CreateComment)}
              />
              <Route
                path="/login"
